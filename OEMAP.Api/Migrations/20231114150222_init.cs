        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseEnrollments_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "mühendislik alanı", "Psikolji" },
                    { 2, "mühendislik alanı", "Mühendislik" },
                    { 3, "mühendislik alanı", "Dil" },
                    { 4, "mühendislik alanı", "Güzel Sanatlar" },
                    { 5, "mühendislik alanı", "Finans" },
                    { 6, "mühendislik alanı", "Bilim" }
                });
